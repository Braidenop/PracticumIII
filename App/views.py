...
def seguridadInformacion(request):

    return render( request, 'SeguridadInformacion.html')


def ataquesInformaticos(request):

    return render( request, 'Ataquesinformaticos.html')


def sitiosConfiables(request):

    return render( request, 'Sitiosconfiables.html')